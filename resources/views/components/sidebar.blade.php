...
<div class="py-16 text-center">
    <button type="button"
        ...
        aria-haspopup="dialog" aria-expanded="false" aria-controls="hs-offcanvas-example" aria-label="Toggle navigation"
...
<div id="hs-offcanvas-example"
    ...
    <div class="px-6 flex items-center">
        <a href="#" aria-label="Brand"
            class="flex-none focus:outline-none focus:opacity-80 flex items-center justify-center">
            <!-- Logo untuk Light Mode -->
            <img src="{{ asset('assets/images/sangkuriang.jpg') }}" alt="Brand Logo" class="h-8 dark:hidden" />

            <!-- Logo untuk Dark Mode -->
            <img src="{{ asset('assets/images/Sangkuriang.png') }}" alt="Brand Logo" class="h-8 hidden dark:block" />
        </a>
    </div>
    <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
        <ul class="space-y-1.5">
            ...
            @if (Auth::user()->roles->contains('name', 'karyawan'))
                <li>
                    <p class="text-sm font-semibold text-gray-700 dark:text-neutral-300 mt-5">Karyawan</p>
                </li>
            ...
            @if (Auth::user()->roles->contains('name', 'manajemen'))
                <li>
                    <p class="text-sm font-semibold text-gray-700 dark:text-neutral-300 mt-5">Manajemen</p>
                </li>
                <li><a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300"
                        href="{{ route('manajemen.absensi.index') }}"">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <rect width="18" height="18" x="3" y="4" rx="2" ry="2" />
                ...
                <li><a class="flex items-center gap-x-3.5 py-2 px-2.5 text-sm text-gray-700 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-700 dark:text-neutral-400 dark:hover:text-neutral-300"
                        href="{{ route('manajemen.log.index') }}"">
                        <svg class="size-4" xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                            stroke-linecap="round" stroke-linejoin="round">
                            <path
            ...
            @if (Auth::user()->roles->contains('name', 'admin'))
                <li>
                    <p class="text-sm font-semibold text-gray-700 dark:text-neutral-300 mt-5">Administrator</p>
                </li>
